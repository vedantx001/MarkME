          ...
          <div key={teacher.id} className="bg-[#FBFDFF] p-5 rounded-2xl border border-[#2D3748]/5 shadow-sm hover:shadow-md transition-all group">
            <div className="flex justify-between items-start mb-4">
              ...
              <div className="flex items-center gap-2">
                <button onClick={() => openEdit(teacher)} className="text-[#2D3748]/30 hover:text-[#2D3748] transition-colors" title="Edit">
                  <Pencil size={18} />
                </button>
                <button
                  onClick={() => handleDelete(teacher)}
                  disabled={deletingId === teacher.id}
                  className="text-[#2D3748]/30 hover:text-red-500 transition-colors disabled:opacity-40"
                  title="Delete"
                >
                  <Trash2 size={18} />
                </button>
