    ...
    >
      ...
      <div className="flex items-center gap-4 lg:gap-6">
        <div className="hidden md:flex items-center gap-3">
          <button className="p-2 text-(--primary-accent) opacity-40 hover:opacity-100 transition-colors">
            <Search size={20} />
          </button>
          <button className="relative p-2 text-(--primary-accent) opacity-40 hover:opacity-100 transition-colors">
            <Bell size={20} />
            <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-(--secondary-accent) rounded-full border-2 border-(--primary-bg)"></span>
          </button>
        </div>
