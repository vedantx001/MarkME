...
import { X, User, Mail, Lock, ShieldCheck, ToggleLeft, ToggleRight, Eye, EyeOff } from 'lucide-react';
import { useAdmin } from '../../context/adminContext';

const EditPrincipalForm = ({ isOpen, onClose, principal }) => {
  const { updatePrincipal } = useAdmin();
          ...
          >
            <div className="bg-(--primary-accent) p-6 flex justify-between items-center text-(--primary-bg)">
              <div className="flex items-center gap-3">
                <ShieldCheck className="text-(--secondary-accent)" />
                <div>
                  <h3 className="text-xl font-bold">Edit Principal</h3>
                  <p className="text-(--secondary-accent) text-sm opacity-90">Update principal profile</p>
                </div>
              </div>
              <button
                onClick={onClose}
...
export default EditPrincipalForm;
