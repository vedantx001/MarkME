  ...
  return (
    <AnimatePresence>
      {isOpen ? (
        ...
        >
          <Motion.div
            className="bg-(--primary-bg) w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden border border-[rgb(var(--primary-accent-rgb)/0.1)]"
          ...
          >
            <div className="bg-(--primary-accent) p-6 flex justify-between items-center text-(--primary-bg)">
              <div>
                ...
                <p className="text-(--secondary-accent) text-sm opacity-90">Update admin & school details</p>
              </div>
              <button
                onClick={onClose}
